...
(async () => {
    ...
    const funcionario_create_1 = await Funcionario.create({ idsetor: 3, nome: "Ivo", nascimento: "2000-12-01", telefone: "07280921" });
    const funcionario_create_2 = await Funcionario.create({ idsetor: 2, nome: "OTO", nascimento: "1977-02-07", telefone: "06924324" });
    const funcionario_create_3 = await Funcionario.create({ idsetor: 3, nome: "Carina", nascimento: "1990-09-09", telefone: "02932176" });
